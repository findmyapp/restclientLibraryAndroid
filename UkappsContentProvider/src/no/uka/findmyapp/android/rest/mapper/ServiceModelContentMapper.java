...
public class ServiceModelContentMapper implements IContentMapper {
	...
	public ContentValues mapValues(Serializable object) {
		...
		contentValues.put(ServiceInfoContract.URI, castedObject.getUri()
				.toString());
		...
		contentValues.put(ServiceInfoContract.CONTENTPROVIDER_URI, castedObject
				.getContentProviderUri().toString());
		contentValues.put(ServiceInfoContract.BROADCAST_NOTIFICATION,
				castedObject.getBroadcastNotification());
